...
import { Button, Container, Form, InputGroup, ListGroup, Nav, NavDropdown, Navbar } from 'react-bootstrap'
...
function App() {
  ...
  return (
    ...
    <div className='d-flex flex-column vh-100'>
      ...
      <div
        className={
          sidebarIsOpen ? 'active-nav side-navbar d-flex jusify-content-between flex-wrap flex-column'
            : 'side-navbar d-flex justify-content-between flex-wrap flex-column'
        }
      >
        <ListGroup variant='flush'>

          <ListGroup.Item action className='side-bar-user'>
            <LinkContainer
              to={userInfo ? '/userprofile' : '/signin'}
              onClick={() => setSidebarIsOpen(!sidebarIsOpen)}
            >
              <span>
